...
import com.example.jetnews.ui.authentication.SignInRoute
import com.example.jetnews.ui.authentication.SignInViewModel
...
fun JetnewsNavGraph(
    ...
    NavHost(
        ...
        composable(JetnewsDestinations.SIGN_IN_ROUTE) {
            val signInViewModel: SignInViewModel = viewModel(
                factory = SignInViewModel.provideFactory(appContainer.signInRepository)
            )
            SignInRoute(
