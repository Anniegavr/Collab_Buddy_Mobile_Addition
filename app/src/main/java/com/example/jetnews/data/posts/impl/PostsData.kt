...
val diana = PostAuthor("Diana Fisticanu", "https://medium.com/@diana")
val ion = PostAuthor("Ion Bostan", "https://medium.com/@ion")
val florina = PostAuthor(
    "Florina Muntenescu",
    "https://medium.com/@florina.muntenescu"
)
val Maria =
    PostAuthor("Maria Alcérreca", "https://medium.com/@MariaAlcerreca")
...
val paragraphsPost1 = listOf(
    Paragraph(
        ParagraphType.Text,
        "How my journey at UTM brought me to new countries:"
    ),
    Paragraph(
        ParagraphType.Text,
...
val paragraphsPost2 = listOf(
    Paragraph(
        ParagraphType.Text,
        "Software Engineering is a popular career path nowadays...",
        listOf(
            Markup(
                MarkupType.Link,
                0,
...
val paragraphsPost3 = listOf(
    Paragraph(
        ParagraphType.Text,
        "Learn how to pursue a double degree",
        listOf(
            Markup(
                MarkupType.Link,
                151,
...
val paragraphsPost4 = listOf(
    Paragraph(
        ParagraphType.Text,
        "Explore our multitude of exchange programs"
    ),
    Paragraph(
        ParagraphType.Text,
...
val paragraphsPost5 = listOf(
    ...
    Paragraph(
        ParagraphType.Text,
        "We value our student's experience above everything."
    ),
    Paragraph(
        ParagraphType.Text,
        "Let’s see how our alumni succeeded"
    ),
    Paragraph(
    ...
    Paragraph(
        ParagraphType.Text,
        "Graduate students from UTM come back to deliver courses.",
        listOf(Markup(MarkupType.Code, 0, 3))
    ),
    Paragraph(
        ParagraphType.Text,
        "These courses include the latest practices... ",
    ...
    Paragraph(
        ParagraphType.Bullet,
        "In this era of computers, UTM ensures that every specialty includes digital courses.",
        listOf(Markup(MarkupType.Code, 0, 10))
    ),
    Paragraph(
        ParagraphType.Bullet,
        "We strongly believe technology shall enhance the learning process.",
        listOf(
...
val post1 = Post(
    id = "ad4f6bea7256",
    title = "Exploring the benefits of studying engineering at Technical University of Moldova",
    subtitle = "Find out why Technical University of Moldova is the ideal place to pursue your engineering studies and how it can benefit you in the long run.",
    url = "https://example.com/exploring-benefits-of-engineering-at-tum",
...
val post2 = Post(
    id = "b27a23b4c4e8",
    title = "How Technical University of Moldova is preparing students for the future of engineering",
    subtitle = "Learn about the innovative programs and curriculum being offered by Technical University of Moldova to prepare students for the challenges of the future.",
    url = "https://example.com/tum-preparing-students-for-future-of-engineering",
    publication = publication,
    metadata = Metadata(
        author = diana,
        date = "June 21",
...
val post3 = Post(
    id = "cd1e15613a87",
    title = "How Technical University of Moldova is contributing to the development of the engineering industry",
    subtitle = "Read about the initiatives and research being conducted by Technical University of Moldova to contribute to the growth and development of the engineering industry.",
    url = "https://example.com/tum-contributing-to-engineering-industry-development",
    publication = publication,
    metadata = Metadata(
        author = ion,
        date = "August 11",
...
val post4 = Post(
    id = "e12d57c8fc0f",
    title = "Career opportunities for engineering graduates from Technical University of Moldova",
    subtitle = "Explore the various career paths available to engineering graduates from Technical University of Moldova and how the university can help prepare you for them.",
    url = "https://example.com/career-opportunities-for-tum-engineering-graduates",
    publication = publication,
    metadata = Metadata(
        author = diana,
        date = "November 02",
...
val post5 = Post(
    ...
    subtitle = "Working with several companies as partners…",
